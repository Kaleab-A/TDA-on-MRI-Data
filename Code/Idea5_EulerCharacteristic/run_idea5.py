...
class Idea5Orchestrator(BaseIdeaOrchestrator):
    ...
    @staticmethod
    def _log_data_summary(records: List[SubjectRecord]) -> None:
        ...
        print(f"  Total subjects : {n}  (ADHD={adhd_count}, Control={ctrl_count})")
        ...
        for r in records:
            ...
            label_str = "ADHD" if r.adhd_label == 1 else "Ctrl"
        ...
        print(f"    ADHD : valid={np.isfinite(sev_adhd).sum()}/{len(sev_adhd)}, "
